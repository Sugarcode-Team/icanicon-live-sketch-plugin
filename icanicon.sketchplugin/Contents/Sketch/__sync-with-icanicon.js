...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/sync-with-icanicon.js");
/******/ })
/************************************************************************/
/******/ ({
...
function () {
  ...
  regeneratorRuntime.mark(function _callee() {
    var e, s, t, a, n, _e, _s, _a, _e2;

    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            e = Settings.sessionVariable("username"), s = Settings.sessionVariable("password"), t = "".concat(HOST, "/api/login/");
            a = new FormData();
            a.append("username", e), a.append("password", s);
            n = {
              method: "POST",
              body: a
            };
          ...
          case 10:
            _s = _context.sent;
            _a = JSON.parse(_s).access;

            if (_a) {
              _e2 = Settings.sessionVariable("username");
              UI.message("Logged in as ".concat(_e2)), Settings.setSessionVariable("token", _a);
            } else UI.message("Error during login, please check your username and password for IcanIcon"), Settings.setSessionVariable("token", null);
          ...
          case 15:
            ...
            UI.message("Error during login, please check your username and password for IcanIcon");
  ...
  var e = {
    initialValue: "Password"
      ...
      s = function s(e, _s2) {
    Settings.setSessionVariable("password", _s2);
  };

  UI.getInputFromUser("Please introduce your username for IcanIcon", {
    initialValue: "Username"
  }, function (t, a) {
    Settings.setSessionVariable("username", a), UI.getInputFromUser("Please introduce your password for IcanIcon", e, s);
  });
},
    getTeams =
/*#__PURE__*/
function () {
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            e = Settings.sessionVariable("token"), s = "".concat(HOST, "/api/teams/"), t = {
              headers: {
          ...
          case 7:
            a = _context2.sent;
            Settings.setSessionVariable("teams", a);
            _context2.next = 14;
            break;
          ...
          case 11:
            ...
            UI.message(_context2.t0), console.log("Error", _context2.t0);
  ...
  var e = Settings.sessionVariable("teams"),
      s = e.map(function (e) {
    return e.name;
  });
  UI.getInputFromUser("Please select a team.", {
    type: UI.INPUT_TYPE.selection,
    possibleValues: s
  }, function (s, t) {
    UI.message("Current team: ".concat(t)), t = e.find(function (e) {
      return e.name === t;
    }), Settings.setSessionVariable("currentTeam", t);
  });
},
    exportIcon = function exportIcon(e, s, t) {
  if (console.log(e.type), "Artboard" === e.type || "Group" === e.type) {
    var _s3 = e,
        a = {
      formats: "svg",
      output: !1
    };
    var n = sketch__WEBPACK_IMPORTED_MODULE_0___default.a.export(_s3, a);
    t.push({
      svg: n,
      name: e.name
    });
    ...
    createOrUpdateSketchBoard =
/*#__PURE__*/
function () {
  var _ref3 = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee3(e) {
    var s, t, a, n, o, r, i, c, l, g, _e4, _s4, _t, _a2, u, p, m, d;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            e.pages.forEach(function (e) {
              ...
              e.layers.forEach(function (e) {
                return exportIcon(e, 0, s);
              }), t.push({
                segment: a,
                icons: s
              });
            }), console.log(t);
            a = splitRequest(t), n = Settings.sessionVariable("currentTeam").id, o = Settings.sessionVariable("token"), r = Settings.sessionVariable("boardName"), i = a.reduce(function (e, s) {
              return e + s.icons.length;
            }, 0), c = "".concat(HOST, "/api/createOrUpdateSketchBoard/");
            l = [], g = 1;
            UI.message("Uploading: 0%");
            _context3.prev = 5;
            _context3.t0 = regeneratorRuntime.keys(a);
          ...
          case 7:
            ...
            _e4 = _context3.t1.value;
            _s4 = a[_e4];
            _context3.t2 = regeneratorRuntime.keys(_s4.icons);
          ...
          case 11:
            ...
            _t = _context3.t3.value;
            _a2 = _s4.icons[_t];
            u = {
              first_request: "0" === "".concat(_e4) && "0" === "".concat(_t),
              first_segment_request: "0" === "".concat(_t),
              team: n,
              board_name: r,
              segment_name: _s4.name,
              icons: _a2
            };
            p = {
              method: "POST",
          ...
          case 18:
            m = _context3.sent;
            d = parseFloat(g.toFixed(2)) / parseFloat(i.toFixed(2)) * 100;

            if (!(UI.message("Uploading: ".concat(d, "%")), g += 1, l.push(m.status), 200 !== m.status)) {
              _context3.next = 22;
              break;
            }
          ...
          case 28:
            ...
            return _context3.abrupt("return", (UI.message("Error: ".concat(_context3.t4)), void console.log(_context3.t4)));

          case 31:
            UI.message("Your icons are exported successfully.");
  ...
  return function createOrUpdateSketchBoard(_x) {
    return _ref3.apply(this, arguments);
  };
}(),
    setBoardName = function setBoardName(e) {
  var s = e.path;
  if (!s) throw UI.message("Please set a name for your sketch project and save before syncing with IcanIcon"), new Error("No projectName set");
  var t = (s = s.split("/").pop()).replace(".sketch", "");
  Settings.setSessionVariable("boardName", t);
};

function splitRequest(e) {
  var s = [];
  ...
  for (var t in e) {
    ...
    s.push({
      name: a,
      icons: []
    }), s[t].icons = e[t].icons.reduce(function (e, s, t) {
    ...
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            console.log("---Running IcanIcon plugin---");
            e = sketch__WEBPACK_IMPORTED_MODULE_0___default.a.getSelectedDocument();
            setBoardName(e);

            if (!Settings.sessionVariable("token")) {
              _context4.next = 8;
              break;
            }
          ...
          case 16:
            createOrUpdateSketchBoard(e);
            console.log("---Icanicon end---");
...
;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@skpm/promise/index.js */ "./node_modules/@skpm/promise/index.js"), __webpack_require__(/*! ./node_modules/sketch-polyfill-fetch/lib/form-data.js */ "./node_modules/sketch-polyfill-fetch/lib/form-data.js")))
...
//# sourceMappingURL=__sync-with-icanicon.js.map